...
**338** rules are included from [`@code-pushup/eslint-config/angular`](./angular.md#📏-rules-338). For brevity, only the **30** additional rules are listed in this document.
