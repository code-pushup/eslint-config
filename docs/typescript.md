...
**249** rules are included from the default config. For brevity, only the **30** additional rules are listed in this document.

Refer to the extended config's docs:

- [`@code-pushup` rules](./index.md#📏-rules-249)
