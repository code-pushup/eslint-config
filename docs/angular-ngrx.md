...
**339** rules are included from [`@code-pushup/eslint-config/angular`](./angular.md#📏-rules-339). For brevity, only the **28** additional rules are listed in this document.
