...
**256** rules are included from the default config. For brevity, only the **41** additional rules are listed in this document.

Refer to the extended config's docs:

- [`@code-pushup` rules](./index.md#📏-rules-256)
