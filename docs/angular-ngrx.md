...
**337** rules are included from `@code-pushup/eslint-config/angular`. For brevity, only the **30** additional rules are listed in this document.

Refer to the extended config's docs:

- [`@code-pushup/eslint-config/angular` rules](./angular.md#📏-rules-337)
...
| [![@ngrx](./icons/other/ngrx.png)](https://ngrx.io/guide/eslint-plugin) | [use-consistent-global-store-name](https://ngrx.io/guide/eslint-plugin/rules/use-consistent-global-store-name)<br>Use a consistent name for the global store. | <details><summary>store$</summary><pre>"store$"</pre></details> | 💡 |  |
